...
namespace TestProjectAPI2022
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7210/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7210/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "samuel@samuel.com";
                string senha = "Sazzu@123456";
                var dados = new
                {
                    email = login,
                    senha = senha,
